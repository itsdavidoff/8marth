...
const compliments = [
 ...
 "Ты самая прекрасная!",
 "Твои глаза — самые прекрасные!",
 "Ты делаешь каждый день особенным!",
 "Ты моя принцесса и вдохновение!",
 "Твоя красота затмевает весенние цветы!",
 "Ты — моя любимая кицька!",
 "С тобой мир становится ярче!",
 "Твой смех — лучша что я слышал!",
...
const mediaData = [
    {
        type: 'image',
        src: 'images/11.jpg',
        comment: 'Наша самое крутое путишествие',
    },
    {
        type: 'image',
        src: 'images/Sneg2.jpg',
        comment: 'Идет снег и мы очень рады😊',
    },
    {
        type: 'image', 
        src: 'images/Krasota.jpg',
        comment: 'Тут ты очень мили и красиви☺️',
    },
    {
        type: 'image', 
        src: 'images/Modni.jpg',
